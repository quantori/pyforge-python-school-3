...
from src.repository.molecule_repositories import RepositoryItem, KEY
...
class Molecule(RepositoryItem[int]):
    ...
    def __init__(self, smiles: str, molecule_name: str | None = None, description: str | None = None):
        self.__molecule_id: int = Molecule.__next_id
    ...
    def get_id(self) -> KEY:
        return self.__molecule_id

    def set_id(self, new_id: KEY) -> None:
        self.__molecule_id = new_id
