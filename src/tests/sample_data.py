...
def schema_methanol():
    return AddMoleculeRequest(smiles="CCO", molecule_name="Methanol", description="Methanol is the simplest alcohol.")


def schema_benzene():
    return AddMoleculeRequest(smiles="c1ccccc1", molecule_name="Benzene", description="Benzene is an aromatic hydrocarbon.")


def schema_acetic_acid():
    return AddMoleculeRequest(smiles="CC(=O)O", molecule_name="Acetic Acid",
                              description="Acetic acid is a simple carboxylic acid.")


def schema_toluene():
    return AddMoleculeRequest(smiles="Cc1ccccc1", molecule_name="Toluene", description="Toluene is a common solvent.")
